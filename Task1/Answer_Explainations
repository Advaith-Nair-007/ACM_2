...
I first identified the columns that contained missing values and treated numerical and categorical features separately.
...
For categorical features, I used the mode, as it is the most appropriate method for replacing missing values in categorical data.
